...
import com.po.reservation.exception.ResourceExceptionResponse;
@ControllerAdvice
@RestController
public class CustomisedResourceExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@ExceptionHandler(ContainerResourceNotFoundException.class)
	public final ResponseEntity<Object> handleContainerResourceNotFoundException(ContainerResourceNotFoundException ex, WebRequest request) throws Exception {
